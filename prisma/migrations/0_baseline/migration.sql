...
-- CreateEnum
CREATE TYPE "WebhookEventStatus" AS ENUM ('RECEIVED', 'SUCCESS', 'FAILED', 'UNHANDLED');

-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('STRIPE');

-- CreateEnum
CREATE TYPE "CleanupTaskType" AS ENUM ('STRIPE_CUSTOMER');

-- CreateEnum
CREATE TYPE "CleanupTaskStatus" AS ENUM ('PENDING', 'DONE', 'FAILED');

-- CreateEnum
CREATE TYPE "SubscriptionStatus" AS ENUM ('ACTIVE', 'PAST_DUE', 'CANCELLED', 'EXPIRED', 'TRIALING', 'PAUSED', 'INCOMPLETE');
...
-- CreateEnum
CREATE TYPE "SubscriptionEventType" AS ENUM ('CREATED', 'RENEWED', 'UPGRADED', 'DOWNGRADED', 'CANCELLED', 'EXPIRED', 'PAUSED', 'RESUMED', 'PAYMENT_FAILED', 'PAYMENT_RECOVERED', 'PAYMENT_ACTION_REQUIRED');
...
CREATE TABLE "User" (
    ...
    "id" SERIAL NOT NULL,
    "password" TEXT NOT NULL DEFAULT '$2a$10$jeaeQtlxxRmjRqVD/h9HnOC2GANB1oKKPAraPazA81nbgJcpOsIyG',
...
CREATE TABLE "CleanupTask" (
    "id" TEXT NOT NULL,
    "type" "CleanupTaskType" NOT NULL,
    "target" TEXT NOT NULL,
    "status" "CleanupTaskStatus" NOT NULL DEFAULT 'PENDING',
...
-- CreateIndex
CREATE UNIQUE INDEX "CleanupTask_type_target_key" ON "CleanupTask"("type", "target");
